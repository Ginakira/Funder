...
#define ID_COL 0                   // ID
#define CODE_COL 1                 // 基金代码
#define NAME_COL 2                 // 基金名称
#define HOLDING_UNIT_COST_COL 3    // 持仓成本
#define HOLDING_SHARE_COL 4        // 持有份额
#define HOLDING_TOTAL_COST_COL 5   // 成本金额
#define HOLDING_EARNINGS_COL 6     // 持有收益
#define HOLDING_EARNING_RATE_COL 7 // 持有收益率
#define HOLDING_AMOUNT_COL 8       // 持有总金额
#define NAV_COL 9                  // 单位净值
#define NAV_GAINS_COL 10           // 净值涨跌
#define NAV_TIME_COL 11            // 净值时间
#define VALUATION_COL 12           // 盘中估值
#define VALUATION_GAINS_COL 13     // 估值涨跌
#define VALUATION_TIME_COL 14      // 估值时间
#define EXPECTED_EARNINGS_COL 15   // 预计收益
#define REMARKS_COL 16 // 备注
